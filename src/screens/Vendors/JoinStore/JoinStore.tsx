                        ...
                        <Box  my="8px">
                            {
                                                        ...
                                                        stores.map((store) => (
                                                            <TouchableOpacity onPress={() => onSelectStore(store)}  key={store.id}>
                                                                <HStack alignItems="center"  width="full"  space={1} px="10px" py="10px" borderBottomColor={"gray.100"} borderBottomWidth={1}>
                                                                    <Image rounded="md" width="50px" height="50px" backgroundColor={"gray.200"} source={{uri: store.store_logo}} />
                                                                    <VStack flex={1}>
                                ...
                                <HStack alignItems="center" width="full"  space={1} px="10px" py="10px" borderBottomColor={"gray.100"} borderBottomWidth={1}>
                                    <Image rounded="md" width="50px" height="50px" backgroundColor={"gray.200"} source={{uri: selectedStore?.store_logo}} />
                                    <VStack flex={1}>
